package de.oehme.xtend.querydsl
...
class QueryDslExtensions {
	...
	def static <T extends Comparable<?>> operator_lessThan(ComparableExpression<T> left,
		Expression<T> right) {
		left.lt(right)
	}

	def static <T extends Comparable<?>> operator_lessEqualsThan(ComparableExpression<T> left,
		T right) {
		left.loe(right)
	}
	...
	def static <T extends Comparable<?>> operator_greaterThan(ComparableExpression<T> left,
		Expression<T> right) {
		left.gt(right)
	}

	def static <T extends Comparable<?>> operator_greaterEqualsThan(ComparableExpression<T> left,
		T right) {
		left.goe(right)
	}
	...
	def static <N extends Number & Comparable<?>> operator_modulo(NumberExpression<N> left,
		Expression<N> right) {
		left.mod(right)
	}
